...
`,Q=`#c20000`,He=`#a6a6a6`,Ue=class extends J{static properties={nome:{type:String},router:{attribute:!1}};static get styles(){return o`${a(Pe)}`}constructor(){super()}render(){return L`
	  ...
	  `}constructor(){super(),this.objeto_os={}}connectedCallback(){super.connectedCallback()}_alterar_nome_cliente=e=>{let t=e.target.value;this.objeto_os.OS.info_cliente.nome_cliente=t,this.objeto_os.salvar_os_localstorage()};render(){return L`
            <!--Retorno renderizado-->
            <div class="form-group">
...
.radio-input label:nth-child(2):has(input:checked) ~ .selection {
 ...
 <div class="form-container">
    ...
    <div class="form-group" style="margin-top: 10px;">
        ...
        `}};customElements.define(`page-os-completa`,at);var ot=class extends J{static properties={notificacoes:{type:Array}};static get styles(){return o`
