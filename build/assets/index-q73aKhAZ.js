...
\f\r]`,A=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ce=/-->/g,le=/>/g,j=RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,`g`),ue=/'/g,M=/"/g,N=/^(?:script|style|textarea|title)$/i,P=(e=>(t,...n)=>({_$litType$:e,strings:t,values:n}))(1),F=Symbol.for(`lit-noChange`),I=Symbol.for(`lit-nothing`),L=new WeakMap,R=T.createTreeWalker(T,129);function z(e,t){if(!O(e)||!e.hasOwnProperty(`raw`))throw Error(`invalid template strings array`);return x===void 0?t:x.createHTML(t)}var de=(e,t)=>{let n=e.length-1,r=[],i,a=t===2?`<svg>`:t===3?`<math>`:``,o=A;for(let t=0;t<n;t++){let n=e[t],s,c,l=-1,u=0;for(;u<n.length&&(o.lastIndex=u,c=o.exec(n),c!==null);)u=o.lastIndex,o===A?c[1]===`!--`?o=ce:c[1]===void 0?c[2]===void 0?c[3]!==void 0&&(o=j):(N.test(c[2])&&(i=RegExp(`</`+c[2],`g`)),o=j):o=le:o===j?c[0]===`>`?(o=i??A,l=-1):c[1]===void 0?l=-2:(l=o.lastIndex-c[2].length,s=c[1],o=c[3]===void 0?j:c[3]===`"`?M:ue):o===M||o===ue?o=j:o===ce||o===le?o=A:(o=j,i=void 0);let d=o===j&&e[t+1].startsWith(`/>`)?` `:``;a+=o===A?n+oe:l>=0?(r.push(s),n.slice(0,l)+S+n.slice(l)+C+d):n+C+(l===-2?t:d)}return[z(e,a+(e[n]||`<?>`)+(t===2?`</svg>`:t===3?`</math>`:``)),r]},B=class e{constructor({strings:t,_$litType$:n},r){let i;this.parts=[];let a=0,o=0,s=t.length-1,c=this.parts,[l,u]=de(t,n);if(this.el=e.createElement(l,r),R.currentNode=this.el.content,n===2||n===3){let e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;(i=R.nextNode())!==null&&c.length<s;){if(i.nodeType===1){if(i.hasAttributes())for(let e of i.getAttributeNames())if(e.endsWith(S)){let t=u[o++],n=i.getAttribute(e).split(C),r=/([.?@])?(.*)/.exec(t);c.push({type:1,index:a,name:r[2],strings:n,ctor:r[1]===`.`?pe:r[1]===`?`?me:r[1]===`@`?he:U}),i.removeAttribute(e)}else e.startsWith(C)&&(c.push({type:6,index:a}),i.removeAttribute(e));if(N.test(i.tagName)){let e=i.textContent.split(C),t=e.length-1;if(t>0){i.textContent=b?b.emptyScript:``;for(let n=0;n<t;n++)i.append(e[n],E()),R.nextNode(),c.push({type:2,index:++a});i.append(e[t],E())}}}else if(i.nodeType===8)if(i.data===w)c.push({type:2,index:a});else{let e=-1;for(;(e=i.data.indexOf(C,e+1))!==-1;)c.push({type:7,index:a}),e+=C.length-1}a++}}static createElement(e,t){let n=T.createElement(`template`);return n.innerHTML=e,n}};function V(e,t,n=e,r){if(t===F)return t;let i=r===void 0?n._$Cl:n._$Co?.[r],a=D(t)?void 0:t._$litDirective$;return i?.constructor!==a&&(i?._$AO?.(!1),a===void 0?i=void 0:(i=new a(e),i._$AT(e,n,r)),r===void 0?n._$Cl=i:(n._$Co??=[])[r]=i),i!==void 0&&(t=V(e,i._$AS(e,t.values),i,r)),t}var fe=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:n}=this._$AD,r=(e?.creationScope??T).importNode(t,!0);R.currentNode=r;let i=R.nextNode(),a=0,o=0,s=n[0];for(;s!==void 0;){if(a===s.index){let t;s.type===2?t=new H(i,i.nextSibling,this,e):s.type===1?t=new s.ctor(i,s.name,s.strings,this,e):s.type===6&&(t=new ge(i,this,e)),this._$AV.push(t),s=n[++o]}a!==s?.index&&(i=R.nextNode(),a++)}return R.currentNode=T,r}p(e){let t=0;for(let n of this._$AV)n!==void 0&&(n.strings===void 0?n._$AI(e[t]):(n._$AI(e,n,t),t+=n.strings.length-2)),t++}},H=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,n,r){this.type=2,this._$AH=I,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=V(this,e,t),D(e)?e===I||e==null||e===``?(this._$AH!==I&&this._$AR(),this._$AH=I):e!==this._$AH&&e!==F&&this._(e):e._$litType$===void 0?e.nodeType===void 0?se(e)?this.k(e):this._(e):this.T(e):this.$(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==I&&D(this._$AH)?this._$AA.nextSibling.data=e:this.T(T.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:n}=e,r=typeof n==`number`?this._$AC(e):(n.el===void 0&&(n.el=B.createElement(z(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===r)this._$AH.p(t);else{let e=new fe(r,this),n=e.u(this.options);e.p(t),this.T(n),this._$AH=e}}_$AC(e){let t=L.get(e.strings);return t===void 0&&L.set(e.strings,t=new B(e)),t}k(t){O(this._$AH)||(this._$AH=[],this._$AR());let n=this._$AH,r,i=0;for(let a of t)i===n.length?n.push(r=new e(this.O(E()),this.O(E()),this,this.options)):r=n[i],r._$AI(a),i++;i<n.length&&(this._$AR(r&&r._$AB.nextSibling,i),n.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let t=ae(e).nextSibling;ae(e).remove(),e=t}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},U=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,n,r,i){this.type=1,this._$AH=I,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=i,n.length>2||n[0]!==``||n[1]!==``?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=I}_$AI(e,t=this,n,r){let i=this.strings,a=!1;if(i===void 0)e=V(this,e,t,0),a=!D(e)||e!==this._$AH&&e!==F,a&&(this._$AH=e);else{let r=e,o,s;for(e=i[0],o=0;o<i.length-1;o++)s=V(this,r[n+o],t,o),s===F&&(s=this._$AH[o]),a||=!D(s)||s!==this._$AH[o],s===I?e=I:e!==I&&(e+=(s??``)+i[o+1]),this._$AH[o]=s}a&&!r&&this.j(e)}j(e){e===I?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??``)}},pe=class extends U{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===I?void 0:e}},me=class extends U{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==I)}},he=class extends U{constructor(e,t,n,r,i){super(e,t,n,r,i),this.type=5}_$AI(e,t=this){if((e=V(this,e,t,0)??I)===F)return;let n=this._$AH,r=e===I&&n!==I||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,i=e!==I&&(n===I||r);r&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH==`function`?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},ge=class{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){V(this,e)}},_e=y.litHtmlPolyfillSupport;_e?.(B,H),(y.litHtmlVersions??=[]).push(`3.3.3`);var ve=(e,t,n)=>{let r=n?.renderBefore??t,i=r._$litPart$;if(i===void 0){let e=n?.renderBefore??null;r._$litPart$=i=new H(t.insertBefore(E(),e),e,void 0,n??{})}return i._$AI(e),i},W=globalThis,G=class extends v{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=ve(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return F}};G._$litElement$=!0,G.finalized=!0,W.litElementHydrateSupport?.({LitElement:G});var ye=W.litElementPolyfillSupport;ye?.({LitElement:G}),(W.litElementVersions??=[]).push(`4.2.2`);var K=new WeakMap,q=e=>{if((e=>e.pattern!==void 0)(e))return e.pattern;let t=K.get(e);return t===void 0&&K.set(e,t=new URLPattern({pathname:e.path})),t},be=class{constructor(e,t,n){this.routes=[],this.o=[],this.t={},this.i=e=>{if(e.routes===this)return;let t=e.routes;this.o.push(t),t.h=this,e.stopImmediatePropagation(),e.onDisconnect=()=>{this.o?.splice(this.o.indexOf(t)>>>0,1)};let n=J(this.t);n!==void 0&&t.goto(n)},(this.l=e).addController(this),this.routes=[...t],this.fallback=n?.fallback}link(e){if(e?.startsWith(`/`))return e;if(e?.startsWith(`.`))throw Error(`Not implemented`);return e??=this.u,(this.h?.link()??``)+e}async goto(e){let t;if(this.routes.length===0&&this.fallback===void 0)t=e,this.u=``,this.t={0:t};else{let n=this.p(e);if(n===void 0)throw Error(`No route found for `+e);let r=q(n).exec({pathname:e})?.pathname.groups??{};if(t=J(r),typeof n.enter==`function`&&!1===await n.enter(r))return;this.v=n,this.t=r,this.u=t===void 0?e:e.substring(0,e.length-t.length)}if(t!==void 0)for(let e of this.o)e.goto(t);this.l.requestUpdate()}outlet(){return this.v?.render?.(this.t)}get params(){return this.t}p(e){let t=this.routes.find((t=>q(t).test({pathname:e})));return t||this.fallback===void 0?t:this.fallback?{...this.fallback,path:`/*`}:void 0}hostConnected(){this.l.addEventListener(Y.eventName,this.i);let e=new Y(this);this.l.dispatchEvent(e),this._=e.onDisconnect}hostDisconnected(){this._?.(),this.h=void 0}},J=e=>{let t;for(let n of Object.keys(e))/\d+/.test(n)&&(t===void 0||n>t)&&(t=n);return t&&e[t]},Y=class e extends Event{constructor(t){super(e.eventName,{bubbles:!0,composed:!0,cancelable:!1}),this.routes=t}};Y.eventName=`lit-routes-connected`;var xe=location.origin||location.protocol+`//`+location.host,Se=class extends be{constructor(){super(...arguments),this.m=e=>{let t=e.button!==0||e.metaKey||e.ctrlKey||e.shiftKey;if(e.defaultPrevented||t)return;let n=e.composedPath().find((e=>e.tagName===`A`));if(n===void 0||n.target!==``||n.hasAttribute(`download`)||n.getAttribute(`rel`)===`external`)return;let r=n.href;if(r===``||r.startsWith(`mailto:`))return;let i=window.location;n.origin===xe&&(e.preventDefault(),r!==i.href&&(window.history.pushState({},``,r),this.goto(n.pathname)))},this.R=e=>{this.goto(window.location.pathname)}}hostConnected(){super.hostConnected(),window.addEventListener(`click`,this.m),window.addEventListener(`popstate`,this.R),this.goto(window.location.pathname)}hostDisconnected(){super.hostDisconnected(),window.removeEventListener(`click`,this.m),window.removeEventListener(`popstate`,this.R)}},Ce=`h1{font-size:var(--header-1)}h2{font-size:var(--header-2)}h3{font-size:var(--header-3)}p,a{font-size:var(--paragraph)}nav{background-color:var(--header-color);box-sizing:border-box;z-index:4000;justify-content:space-around;align-items:center;width:100%;margin-left:auto;margin-right:auto;padding:.2rem 0;display:flex;position:fixed;bottom:0}nav a svg{width:1.7rem;fill:var(--text-color)}nav a{text-align:center;width:7rem;color:var(--text-color);border-radius:.7rem;padding:.2rem;font-weight:600;text-decoration:none;transition:background-color .2s}nav a:hover{background-color:var(--destaque-color)}nav a p{margin:0;font-size:.8rem}@media (width>=1024px){nav{background-color:var(--background-color);border-radius:100rem;width:50%;margin-bottom:.5rem;padding:.4rem}nav a p{font-size:1rem}nav a{border-radius:100rem;width:9rem;padding-bottom:.1rem}}#container-drawer-ferramentas{flex-direction:column;justify-content:space-between;row-gap:1rem;padding:2rem 0 0;display:flex}#container-drawer-ferramentas a{flex-direction:row;align-items:center;gap:1rem;width:100%;display:flex}#container-drawer-ferramentas a svg{fill:var(--destaque-color)}`,we=`#container{box-sizing:border-box;opacity:0;visibility:hidden;z-index:9999;background-color:#0009;flex-direction:column;justify-content:center;align-items:center;width:100vw;height:100vh;padding:2rem;transition:opacity .3s,visibility .3s;display:flex;position:fixed;top:0;left:0}#container.visivel{opacity:1;visibility:visible}#modal{background-color:var(--background-color);color:var(--text-color);text-align:center;border-color:var(--btn-border-color);box-sizing:border-box;border-style:solid;border-width:2px;border-radius:2rem;flex-direction:column;justify-content:center;transition:transform .3s;display:flex;transform:scale(.9)translateY(20px);box-shadow:0 20px 50px #ffffff38}#container.visivel #modal{transform:scale(1)translateY(0)}#modal svg{fill:var(--text-color);height:5rem}input{background-color:var(--btn-background-color);width:15rem;color:var(--btn-text-background-color);border:.1rem solid;border-color:var(--btn-border-color);border-radius:100rem;margin:1rem;padding:.5rem;font-size:1rem}button{background-color:var(--btn-background-color);width:15rem;color:var(--text-color);border:none;border-radius:100rem;margin:1rem;padding:.5rem;font-size:1rem;transition:background-color .1s}button:hover{background-color:var(--destaque-color);color:var(--text-color)}#close-button{justify-content:flex-end;align-items:center;height:2rem;margin:0;padding:.9rem;display:flex}#close-button a svg{fill:#b00;transform-origin:50%;width:2.5rem;transition:transform .2s}#close-button a svg:hover{transform:scale(1.2)}@media (width>=1024px){#modal{width:50%}}`,Te=e=>{localStorage.setItem(`usuario`,e)},Ee=class extends G{static properties={aberto:{type:Boolean}};static get styles(){return o`${a(we)}`}constructor(){super(),this.url_config=``,this.aberto=!1}Btn_Cadastro(e){let t=e.target.form,n=new FormData(t).get(`nome`);n!==``&&(Te(n),this._dispararFechar())}_dispararFechar(){this.aberto=!1,this.dispatchEvent(new CustomEvent(`ao-fechar`,{bubbles:!0,composed:!0}))}render(){return P`
        ...
        `}};customElements.define(`modal-cadastro-user`,Ee);var De=class extends G{static properties={aberto:{type:Boolean}};static styles=o`
  ...
  `;constructor(){super(),this.aberto=!1}render(){return P`
      <div 
    ...
    `}_dispararFechar(){this.aberto=!1,this.dispatchEvent(new CustomEvent(`ao-fechar`,{bubbles:!0,composed:!0}))}};customElements.define(`drawer-esquerdo-ferramentas`,De);var Oe=class extends G{static properties={nome:{type:String},url_config:{type:String},exibirModal:{type:Boolean},exibirDrawerFerramentas:{type:Boolean},exibirDrawerLinks:{type:Boolean},exibirDrawerFinanceiro:{type:Boolean}};static get styles(){return o`${a(Ce)}`}constructor(){super(),this.url_config=``,this.exibirModal=!1,this.exibirDrawerFerramentas=!1,this.exibirDrawerLinks=!1,this.exibirDrawerFinanceiro=!1,this.Verificar_usuario()}Verificar_usuario(){localStorage.getItem(`usuario`)??(this.exibirModal=!0)}render(){return P`
            <!--Retorno renderizado-->
            <nav>
                <a href="/">
  ...
  `;constructor(){super(),this.isDark=document.body.classList.contains(`dark-theme`)}render(){return P`
    ...
    `}_alternarTema(){this.isDark=!this.isDark,document.body.classList.toggle(`dark-theme`,this.isDark),localStorage.setItem(`theme`,this.isDark?`dark`:`light`)}};customElements.define(`botao-tema`,Ae);var je=`:host{box-sizing:border-box;margin:0;padding:0;display:block}#andamento img{width:3rem;height:3rem;padding:1rem}#andamento svg{fill:#fff;width:4rem;height:4rem;padding:1rem}#andamento{opacity:1;text-align:center;color:#fff;background-image:url(/background-alert.webp);background-repeat:no-repeat;background-size:cover;border-radius:1rem;justify-content:space-between;align-items:center;margin-top:.5rem;padding:.1rem;text-decoration:none;transition:opacity .1s;display:flex}#andamento:hover{opacity:.8}`,Me=class extends G{static properties={url_acesso:{type:String}};static get styles(){return o`${a(je)}`}constructor(){super(),this.url_acesso=``}render(){return P`
        ...
        `}};customElements.define(`card-continuar-os`,Me);var X=(e,t)=>{window.dispatchEvent(new CustomEvent(`disparar-alerta`,{detail:{categoria:e,mensagem:t}}))},Z=class{constructor(e={}){this.OS=e}salvar_os_localstorage(){localStorage.setItem(`OS`,JSON.stringify(this.OS))}carregar_os_localstorage(){let e=JSON.parse(localStorage.getItem(`OS`));this.OS=e}verificar_os_localstorage=()=>{let e=JSON.parse(localStorage.getItem(`OS`));if(e!==null)return e.config_OS.tipo_os};carregar_latitude_longitude(e=null){if(e===null){X(`erro`,`O Valor retornado ao método é Nulo`);return}this.OS.endereco_info_os.coordenadas.latitude=e.latitude,this.OS.endereco_info_os.coordenadas.longitude=e.longitude,this.OS.endereco_info_os.coordenadas.precisao=e.precisao,this.salvar_os_localstorage()}alterar_tipo_os=e=>{if(this.OS==={}||this.OS===null){console.log(`entrei`);return}this.OS.config_OS.tipo_os=e,this.salvar_os_localstorage(),X(`sucesso`,`O tipo da OS foi definido para ${e}`)};alterar_informacoes_cliente=(e=[`tipo`,`valor`])=>{switch(e[0]){case`message`:this.OS.info_cliente.parentesco_info=e[1];break;case`parentesco`:this.OS.info_cliente.parentesco=e[1];break;default:return}this.salvar_os_localstorage()}},Ne=class extends G{static properties={nome:{type:String},url_config:{type:String},os_em_aberto:{type:Boolean},url_nova_os:{type:String}};static get styles(){return o`${a(ke)}`}constructor(){super(),this.os_em_aberto=!1,this.url_nova_os=``}connectedCallback(){super.connectedCallback(),this._checar_os_aberta()}_checar_os_aberta=()=>{let e=new Z().verificar_os_localstorage();switch(e===null&&(this.os_em_aberto=!1),e){case`completa`:this.url_nova_os=`/iniciar_os_completa/continue`;break;case`retencao`:this.url_nova_os=`/iniciar_os_completa/retencao`;break;case`retirada`:this.url_nova_os=`/iniciar_os_completa/retirada`;break;case`los`:this.url_nova_os=`/iniciar_os_completa/los`;break;default:return}this.os_em_aberto=!0};render(){return P`
            <!--Retorno renderizado-->
        ...
        `}};customElements.define(`card-os`,Ie);var Le=P`
...
`,Q=`#c20000`,He=`#a6a6a6`,Ue=class extends G{static properties={nome:{type:String},router:{attribute:!1}};static get styles(){return o`${a(Pe)}`}constructor(){super()}render(){return P`
            <!--Retorno renderizado-->
            <header class="header-superior">
        ...
        `}};customElements.define(`select-parentesco`,Ze);var Qe=class extends G{static properties={objeto_os:{type:Object}};static get styles(){return o`
	    host: {
	  ...
	  `}constructor(){super(),this.objeto_os={}}connectedCallback(){super.connectedCallback()}_alterar_nome_cliente=e=>{let t=e.target.value;this.objeto_os.OS.info_cliente.nome_cliente=t,this.objeto_os.salvar_os_localstorage()};render(){return P`
            <!--Retorno renderizado-->
            <div class="form-group">
        ...
        `}};customElements.define(`nome-cliente`,Qe);var $e=class extends G{static properties={objeto_os:{type:Object}};static get styles(){return o`
	    host: {
	  ...
	  `}constructor(){super(),this.objeto_os={}}connectedCallback(){super.connectedCallback()}_alterar_data_cliente=e=>{let t=e.target.value;this.objeto_os.OS.info_cliente.relato_cliente=t,this.objeto_os.salvar_os_localstorage()};render(){return P`
            <!--Retorno renderizado-->
            <div class="form-group">
        ...
        `}};customElements.define(`area-relato-cliente`,$e);var et=class extends G{static properties={objeto_os:{type:Object}};static get styles(){return o`
	    host: {
...
.radio-input label:nth-child(2):has(input:checked) ~ .selection {
  transform: translateX(calc(50% * 2));
	  ...
	  `}constructor(){super(),this.objeto_os={}}connectedCallback(){super.connectedCallback()}_alterar_data_cliente=e=>{let t=e.target.value.toLowerCase()===`true`;this.objeto_os.OS.endereco_info_os.anexo_fachada=t,this.objeto_os.salvar_os_localstorage()};render(){return P`
            <!--Retorno renderizado-->
            <div class="form-group">
        ...
        `}};customElements.define(`faxada-anexada`,et);var tt=class extends G{static properties={objeto_os:{type:Object},info_anexada:{type:Boolean},informacoes_adicionais:{type:Array}};static get styles(){return o`
	    host: {
	  ...
	  `}constructor(){super(),this.objeto_os={},this.info_anexada=!0,this.informacoes_adicionais=[]}connectedCallback(){super.connectedCallback(),this.informacoes_adicionais=this.objeto_os.OS.endereco_info_os.complemento_info_necessaria.requerimentos,this.info_anexada=this.objeto_os.OS.endereco_info_os.info_necessaria}_alterar_data_cliente=e=>{let t=e.target.value.toLowerCase()===`true`;this.objeto_os.OS.endereco_info_os.info_necessaria=t,this.info_anexada=t,this.objeto_os.salvar_os_localstorage()};_alterar_info_OS(e){let t=e.target.checked;switch(e.target.value){case`historico`:this.objeto_os.OS.endereco_info_os.complemento_info_necessaria.info_padrao.historico=t;break;case`comodato`:this.objeto_os.OS.endereco_info_os.complemento_info_necessaria.info_padrao.comodato=t;break;case`descricao`:this.objeto_os.OS.endereco_info_os.complemento_info_necessaria.info_padrao.descricao=t;break;case`contratacao`:this.objeto_os.OS.endereco_info_os.complemento_info_necessaria.info_padrao.contratacao=t;break}this.objeto_os.salvar_os_localstorage()}_add_info_anexada(e){let t=this.shadowRoot.getElementById(`info_extra_titulo`);this.informacoes_adicionais.push(t.value),this.objeto_os.salvar_os_localstorage(),t.value=``,this.requestUpdate()}_remover_info_anexada(e){let t=e.target.id;this.informacoes_adicionais.splice(t,1),this.objeto_os.salvar_os_localstorage(),this.requestUpdate()}_alterar_operador(e){let t=e.target.value;this.objeto_os.OS.endereco_info_os.complemento_info_necessaria.operador=t,this.objeto_os.salvar_os_localstorage()}render(){return P`
            ...
            <div class="form-group">
                ...
                ${this.informacoes_adicionais.length===0?P``:P`
                    ${this.informacoes_adicionais.map((e,t)=>P`
  ...
  `;fechar(){this.remove()}render(){return P`
    ...
    `}};customElements.define(`modal-geral`,it);function at(e,t){let n=document.createElement(`modal-geral`);n.titulo=e,n.texto=t,document.body.appendChild(n)}var ot=class extends G{static properties={objeto_os:{type:Object},info_passadas:{type:Object}};static get styles(){return o`${a(nt)}`}constructor(){super(),this.objeto_os={}}firstUpdated(){}connectedCallback(){super.connectedCallback(),this.info_passadas=this.objeto_os.OS.educacao_cliente}_add_info_passada_cliente(e){let t=e.target.checked,n=e.target.value,r=e.target.id;t?(this.info_passadas[r]=n,this.objeto_os.salvar_os_localstorage()):(delete this.info_passadas[r],this.objeto_os.salvar_os_localstorage())}_verificar_existencia(e){let t=e;return this.info_passadas[t]!==void 0}render(){return P`
            <!--Retorno renderizado-->
        ...
        `}};customElements.define(`atendimento-feito-cliente`,lt);var ut=`:host{color:var(--text-color);margin:0;padding:0}h2{background-color:var(--text-color);color:var(--background-color);text-align:center;border-radius:1rem;padding:1rem}.Container_info_extra{flex-direction:column;row-gap:1rem;display:flex}.item_info_extra{flex-direction:row;align-items:center;gap:1rem;display:flex}.botao-close{appearance:none;color:#fff;cursor:pointer;background-color:var(--destaque-color);border:none;border-radius:6px;height:2rem;padding:5px 12px;display:inline-block}.texto_informativo{font-size:var(--paragraph-info);color:var(--color-text-info)}a svg{fill:var(--text-color);background-color:var(--destaque-color);border-radius:1rem;width:1.5rem;padding:.5rem}.form-container{max-width:auto;font-family:Segoe UI,Tahoma,Geneva,Verdana,sans-serif}.form-group{flex-direction:column;margin-bottom:20px;display:flex}.form-group-row{justify-content:space-between;align-items:center;gap:8px;margin-bottom:15px;display:flex}.form-label{color:var(--btn-text-background-color);margin-bottom:6px;font-size:17px;font-weight:600}.form-label-inline{color:var(--text-color);cursor:pointer;font-size:14px}.form-input,.form-select,.form-textarea{appearance:none;box-sizing:border-box;color:#1a202c;background-color:#f8fafc;border:2px solid #e2e8f0;border-radius:6px;width:100%;padding:10px 12px;font-family:inherit;font-size:15px;transition:border-color .2s,background-color .2s}.form-input:focus,.form-select:focus,.form-textarea:focus{border-color:var(--destaque-color);background-color:#fff;outline:none}.form-select{cursor:pointer;background-image:url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%234a5568' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'%3e%3cpolyline points='6 9 12 15 18 9'%3e%3c/polyline%3e%3c/svg%3e");background-position:right 12px center;background-repeat:no-repeat;background-size:16px;padding-right:40px}.form-textarea{resize:vertical;min-height:100px}.form-radio,.form-checkbox{appearance:none;font:inherit;color:var(--destaque-color);cursor:pointer;background-color:#f8fafc;border:2px solid #cbd5e1;place-content:center;width:18px;height:18px;margin:0;transition:border-color .2s;display:grid}.form-radio{border-radius:50%}.form-checkbox{border-radius:4px}.form-radio:before{content:"";background-color:currentColor;border-radius:50%;width:8px;height:8px;transition:transform .12s ease-in-out;transform:scale(0)}.form-checkbox:before{content:"";clip-path:polygon(14% 44%,0 65%,50% 100%,100% 16%,80% 0%,43% 62%);background-color:currentColor;width:10px;height:10px;transition:transform .12s ease-in-out;transform:scale(0)}.form-radio:checked:before,.form-checkbox:checked:before{transform:scale(1)}.form-radio:checked,.form-checkbox:checked{border-color:var(--destaque-color)}.form-radio:focus,.form-checkbox:focus{outline:2px solid #ebf8ff}.form-button{appearance:none;background-color:var(--destaque-color);color:#fff;cursor:pointer;border:none;border-radius:6px;width:100%;padding:12px 24px;font-family:inherit;font-size:15px;font-weight:600;transition:background-color .2s}.form-button:hover,.form-button:active{background-color:var(--destaque-color)}`,dt=class extends G{static properties={objeto_os:{type:Object},info_anexada:{type:Boolean}};static get styles(){return o`${a(ut)}`}constructor(){super(),this.objeto_os={},this.info_anexada=[]}firstUpdated(){}connectedCallback(){super.connectedCallback(),this.info_anexada=this.objeto_os.OS.complemento_atendimento}_adicionar_informacao=e=>{let t=this.shadowRoot.getElementById(`info_extra_titulo`);this.info_anexada.push(t.value),this.objeto_os.salvar_os_localstorage(),t.value=``,this.requestUpdate()};_remover_info_anexada(e){let t=e.target.id;this.info_anexada.splice(t,1),this.objeto_os.salvar_os_localstorage(),this.requestUpdate()}render(){return P`
            ...
            <div class="Container_info_extra">
                ${this.info_anexada.length===0?P``:P`
                    ${this.info_anexada.map((e,t)=>P`
        ...
        `}};customElements.define(`informacoes-adicionais-passadas`,dt);var ft=`:host{color:var(--text-color);margin:0;padding:0}h2{color:var(--text-color);text-align:center}p{font-size:var(--paragraph);text-align:left;font-weight:100}.container_lista_itens{flex-direction:column;gap:1rem;display:flex}.Container_Item{background-color:var(--cards-background);box-shadow:0px 12px 29px -1px var(--box-shadow);border-radius:1rem;flex-direction:column;margin:0;padding:1rem;display:flex}.container_itens_utp{flex-direction:row;place-content:center space-around;gap:1rem;display:flex}.container_item_utp p{text-align:center}.form-container{max-width:auto;font-family:Segoe UI,Tahoma,Geneva,Verdana,sans-serif}.form-group{flex-direction:column;margin-bottom:20px;display:flex}.form-group-row{justify-content:space-between;align-items:center;gap:8px;margin-bottom:15px;display:flex}.form-label{color:var(--btn-text-background-color);margin-bottom:6px;font-size:17px;font-weight:600}.form-label-inline{color:var(--text-color);cursor:pointer;font-size:14px}.form-input,.form-select,.form-textarea{appearance:none;box-sizing:border-box;color:#1a202c;background-color:#f8fafc;border:2px solid #e2e8f0;border-radius:6px;width:100%;padding:10px 12px;font-family:inherit;font-size:15px;transition:border-color .2s,background-color .2s}.form-input:focus,.form-select:focus,.form-textarea:focus{border-color:var(--destaque-color);background-color:#fff;outline:none}.form-select{cursor:pointer;background-image:url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%234a5568' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'%3e%3cpolyline points='6 9 12 15 18 9'%3e%3c/polyline%3e%3c/svg%3e");background-position:right 12px center;background-repeat:no-repeat;background-size:16px;padding-right:40px}.form-textarea{resize:vertical;width:100%;min-height:100px}.form-radio,.form-checkbox{appearance:none;font:inherit;color:var(--destaque-color);cursor:pointer;background-color:#f8fafc;border:2px solid #cbd5e1;place-content:center;width:18px;height:18px;margin:0;transition:border-color .2s;display:grid}.form-radio{border-radius:50%}.form-checkbox{border-radius:4px}.form-radio:before{content:"";background-color:currentColor;border-radius:50%;width:8px;height:8px;transition:transform .12s ease-in-out;transform:scale(0)}.form-checkbox:before{content:"";clip-path:polygon(14% 44%,0 65%,50% 100%,100% 16%,80% 0%,43% 62%);background-color:currentColor;width:10px;height:10px;transition:transform .12s ease-in-out;transform:scale(0)}.form-radio:checked:before,.form-checkbox:checked:before{transform:scale(1)}.form-radio:checked,.form-checkbox:checked{border-color:var(--destaque-color)}.form-radio:focus,.form-checkbox:focus{outline:2px solid #ebf8ff}.button-sm{appearance:none;background-color:var(--destaque-color);color:#fff;cursor:pointer;border:none;border-radius:6px;width:100%;padding:.5rem .7rem;font-family:inherit;font-size:.9rem;font-weight:500;transition:background-color .2s}.form-button{appearance:none;background-color:var(--destaque-color);color:#fff;cursor:pointer;border:none;border-radius:6px;width:100%;padding:12px 24px;font-family:inherit;font-size:15px;font-weight:600;transition:background-color .2s}.botao-close{appearance:none;color:#fff;cursor:pointer;background-color:var(--destaque-color);border:none;border-radius:6px;padding:5px 12px;display:inline-block}.form-button:hover,.form-button:active{background-color:var(--destaque-color)}.toggle-switch{cursor:pointer;width:40px;height:20px;display:inline-block;position:relative}.toggle-switch input[type=checkbox]{display:none}.toggle-switch-background{background-color:#ddd;border-radius:20px;width:100%;height:100%;transition:background-color .3s ease-in-out;position:absolute;top:0;left:0;box-shadow:inset 0 0 0 2px #ccc}.toggle-switch-handle{background-color:#fff;border-radius:50%;width:20px;height:20px;transition:transform .3s ease-in-out;position:absolute;top:0;left:0;box-shadow:0 2px 5px #0003}.toggle-switch:before{content:"";color:#aaa;text-shadow:1px 1px #fff;font-size:12px;font-weight:700;transition:color .3s ease-in-out;position:absolute;top:-25px;right:-35px}.toggle-switch input[type=checkbox]:checked+.toggle-switch-handle{box-shadow:0 2px 5px #0003, 0 0 0 3px var(--destaque-color);transform:translate(5px)}.toggle-switch input[type=checkbox]:checked+.toggle-switch-background{background-color:var(--destaque-color);box-shadow:inset 0 0 0 2px var(--destaque-color)}.toggle-switch input[type=checkbox]:checked+.toggle-switch:before{content:"On";color:var(--destaque-color);right:-5px}.toggle-switch input[type=checkbox]:checked+.toggle-switch-background .toggle-switch-handle{transform:translate(20px)}.radio-input input{display:none}.radio-input{--container_width:100%;color:#000;width:var(--container_width);background-color:#fff;border:1px solid #3534343a;border-radius:10px;align-items:center;display:flex;position:relative;overflow:hidden}.radio-input label{cursor:pointer;z-index:1;letter-spacing:-1px;justify-content:center;align-items:center;width:100%;padding:10px;font-size:14px;font-weight:600;display:flex}.selection{z-index:0;width:50%;height:100%;transition:all .15s;display:none;position:absolute;top:0;left:0}.radio-input label:has(input:checked){color:#fff}.radio-input label:has(input:checked)~.selection{background-color:var(--destaque-color);display:inline-block}.radio-input label:first-child:has(input:checked)~.selection{transform:translateX(calc(50% / 20%))}.radio-input label:nth-child(2):has(input:checked)~.selection{transform:translate(100%)}`,pt=class extends G{static properties={objeto_os:{type:Object},cabos_utp:{type:Array}};static get styles(){return o`${a(ft)}`}constructor(){super(),this.objeto_os={}}firstUpdated(){}connectedCallback(){super.connectedCallback(),this.cabos_utp=this.objeto_os.OS.conferencia_tecnica.cabos_utp}_adicionar_cabo_utp(e){e.target.value===`WAN`?this.cabos_utp.push({cabo:`WAN`,checagens:[!0,!0,!0],anexo_cabos:!1,observacao:``}):this.cabos_utp.push({cabo:``,checagens:[!0,!0,!0],anexo_cabos:!1,observacao:``}),this.objeto_os.salvar_os_localstorage(),this.requestUpdate()}_deletar_utp=e=>{let t=e.target.id;this.cabos_utp.splice(t,1),this.objeto_os.salvar_os_localstorage(),this.requestUpdate()};_alterar_data_utp=(e,t,n)=>{let r=t,i=n,a=e.target.checked;switch(i){case`primeiro`:this.cabos_utp[r].checagens[0]=a;break;case`segundo`:this.cabos_utp[r].checagens[1]=a;break;case`terceiro`:this.cabos_utp[r].checagens[2]=a;break}this.objeto_os.salvar_os_localstorage()};_alterar_nome_utp=e=>{let t=e.target.value,n=e.target.id;this.cabos_utp[n].cabo=t,this.objeto_os.salvar_os_localstorage()};_alterar_relatorio_utp=e=>{let t=e.target.value,n=e.target.id;this.cabos_utp[n].observacao=t};_alterar_anexo=(e,t)=>{let n=t,r=e.target.value===`true`;this.cabos_utp[n].anexo_cabos=r,this.objeto_os.salvar_os_localstorage()};render(){return P`
            ...
            <div class="container_lista_itens">
                ...
                ${this.cabos_utp.length===0?P``:P`
                    ${this.cabos_utp.map((e,t)=>P`
                        <div class="Container_Item">
                            ...
                            <input 
                                ...
                                value="${e.cabo}" class="form-input"/>
                            
                            <div class="container_itens_utp">
                                <div class="container_item_utp">
                                    <p>Cabo 100/1000?</p>
                                    <label class="toggle-switch">
                                        <input @change="${e=>{this._alterar_data_utp(e,t,`primeiro`)}}" 
                                        ?checked="${e.checagens[0]}"
                                        type="checkbox">
                                ...
                                <div class="container_item_utp">
                                    ...
                                    <label class="toggle-switch">
                                        <input 
                                            @change="${e=>{this._alterar_data_utp(e,t,`segundo`)}}"
                                            ?checked="${e.checagens[1]}"
                                            type="checkbox">
                                        <div class="toggle-switch-background">
                                            <div class="toggle-switch-handle"></div>
                                        </div>
                                ...
                                <div class="container_item_utp">
                                    ...
                                    <label class="toggle-switch">
                                        <input 
                                            @change="${e=>{this._alterar_data_utp(e,t,`terceiro`)}}"
                                            ?checked="${e.checagens[2]}"
                                            type="checkbox">
                                        <div class="toggle-switch-background">
                                            <div class="toggle-switch-handle"></div>
                                        </div>
                            ...
                            <div @change="${e=>{this._alterar_anexo(e,t)}}" class="radio-input">
                                <label>
                                    <input ?checked="${e.anexo_cabos===!0}" value="true" name="Anexo_UTP_${t}" id="value-1" type="radio" />
                                    <span>S i m</span>
                                </label>
                                <label>
                                    <input ?checked="${e.anexo_cabos===!1}" value="false" name="Anexo_UTP_${t}" id="value-2" type="radio" />
                                    <span>N ã o</span>
                                </label>
                                <span class="selection"></span>
                            </div>
        ...
        `}};customElements.define(`verificacao-cabo-utp`,pt);var mt=`:host{color:var(--text-color);margin:0;padding:0}h2{color:var(--text-color);text-align:center}p{font-size:var(--paragraph);text-align:left;font-weight:100}.container_sinal_fibra{flex-direction:row;gap:1rem;display:flex}.texto_informativo{font-size:var(--paragraph-info);color:var(--color-text-info)}.form-container{max-width:auto;font-family:Segoe UI,Tahoma,Geneva,Verdana,sans-serif}.form-group{flex-direction:column;margin-bottom:20px;display:flex}.form-group-row{justify-content:space-between;align-items:center;gap:8px;margin-bottom:15px;display:flex}.form-label{color:var(--btn-text-background-color);margin-bottom:6px;font-size:17px;font-weight:600}.form-label-inline{color:var(--text-color);cursor:pointer;font-size:14px}.form-input.is-disabled{color:#999;pointer-events:none;opacity:.5;cursor:not-allowed}.form-input,.form-select,.form-textarea{appearance:none;box-sizing:border-box;color:#1a202c;background-color:#f8fafc;border:2px solid #e2e8f0;border-radius:6px;width:100%;padding:10px 12px;font-family:inherit;font-size:15px;transition:border-color .2s,background-color .2s}.form-input:focus,.form-select:focus,.form-textarea:focus{border-color:var(--destaque-color);background-color:#fff;outline:none}.form-select{cursor:pointer;background-image:url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%234a5568' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'%3e%3cpolyline points='6 9 12 15 18 9'%3e%3c/polyline%3e%3c/svg%3e");background-position:right 12px center;background-repeat:no-repeat;background-size:16px;padding-right:40px}.form-textarea{resize:vertical;width:100%;min-height:100px}.form-radio,.form-checkbox{appearance:none;font:inherit;color:var(--destaque-color);cursor:pointer;background-color:#f8fafc;border:2px solid #cbd5e1;place-content:center;width:18px;height:18px;margin:0;transition:border-color .2s;display:grid}.form-radio{border-radius:50%}.form-checkbox{border-radius:4px}.form-radio:before{content:"";background-color:currentColor;border-radius:50%;width:8px;height:8px;transition:transform .12s ease-in-out;transform:scale(0)}.form-checkbox:before{content:"";clip-path:polygon(14% 44%,0 65%,50% 100%,100% 16%,80% 0%,43% 62%);background-color:currentColor;width:10px;height:10px;transition:transform .12s ease-in-out;transform:scale(0)}.form-radio:checked:before,.form-checkbox:checked:before{transform:scale(1)}.form-radio:checked,.form-checkbox:checked{border-color:var(--destaque-color)}.form-radio:focus,.form-checkbox:focus{outline:2px solid #ebf8ff}.button-sm{appearance:none;background-color:var(--destaque-color);color:#fff;cursor:pointer;border:none;border-radius:6px;width:100%;padding:.5rem .7rem;font-family:inherit;font-size:.9rem;font-weight:500;transition:background-color .2s}.form-button{appearance:none;background-color:var(--destaque-color);color:#fff;cursor:pointer;border:none;border-radius:6px;width:100%;padding:12px 24px;font-family:inherit;font-size:15px;font-weight:600;transition:background-color .2s}.botao-close{appearance:none;color:#fff;cursor:pointer;background-color:var(--destaque-color);border:none;border-radius:6px;padding:5px 12px;display:inline-block}.form-button:hover,.form-button:active{background-color:var(--destaque-color)}.form-button.habilitado{background-color:var(--background-color);color:var(--text-color)}.toggle-switch{cursor:pointer;width:40px;height:20px;display:inline-block;position:relative}.toggle-switch input[type=checkbox]{display:none}.toggle-switch-background{background-color:#ddd;border-radius:20px;width:100%;height:100%;transition:background-color .3s ease-in-out;position:absolute;top:0;left:0;box-shadow:inset 0 0 0 2px #ccc}.toggle-switch-handle{background-color:#fff;border-radius:50%;width:20px;height:20px;transition:transform .3s ease-in-out;position:absolute;top:0;left:0;box-shadow:0 2px 5px #0003}.toggle-switch:before{content:"";color:#aaa;text-shadow:1px 1px #fff;font-size:12px;font-weight:700;transition:color .3s ease-in-out;position:absolute;top:-25px;right:-35px}.toggle-switch input[type=checkbox]:checked+.toggle-switch-handle{box-shadow:0 2px 5px #0003, 0 0 0 3px var(--destaque-color);transform:translate(5px)}.toggle-switch input[type=checkbox]:checked+.toggle-switch-background{background-color:var(--destaque-color);box-shadow:inset 0 0 0 2px var(--destaque-color)}.toggle-switch input[type=checkbox]:checked+.toggle-switch:before{content:"On";color:var(--destaque-color);right:-5px}.toggle-switch input[type=checkbox]:checked+.toggle-switch-background .toggle-switch-handle{transform:translate(20px)}.radio-input input{display:none}.radio-input{--container_width:100%;color:#000;width:var(--container_width);background-color:#fff;border:1px solid #3534343a;border-radius:10px;align-items:center;display:flex;position:relative;overflow:hidden}.radio-input label{cursor:pointer;z-index:1;letter-spacing:-1px;justify-content:center;align-items:center;width:100%;padding:10px;font-size:14px;font-weight:600;display:flex}.selection{z-index:0;width:50%;height:100%;transition:all .15s;display:none;position:absolute;top:0;left:0}.radio-input label:has(input:checked){color:#fff}.radio-input label:has(input:checked)~.selection{background-color:var(--destaque-color);display:inline-block}.radio-input label:first-child:has(input:checked)~.selection{transform:translateX(calc(50% / 20%))}.radio-input label:nth-child(2):has(input:checked)~.selection{transform:translate(100%)}`,ht=class extends G{static properties={objeto_os:{type:Object},fibra:{type:Object},container_sinais:{type:Boolean}};static get styles(){return o`${a(mt)}`}constructor(){super(),this.objeto_os={},this.container_sinais=!0}firstUpdated(){if(this.fibra.sinal_pto===`LOS`){let e=this.shadowRoot.getElementById(`text_sinal_drop`),t=this.shadowRoot.getElementById(`btn_desabilitar`);e.disabled=!0,e.classList.add(`is-disabled`),t.classList.add(`habilitado`),e.value=0}}connectedCallback(){super.connectedCallback(),this.fibra=this.objeto_os.OS.conferencia_tecnica.fibra,console.log(this.fibra),this.container_sinais=this.fibra.sinal_pto!==`LOS`}_desabilitar_por_LOS=e=>{let t=null;t=this.shadowRoot.getElementById(`text_sinal_drop`),t.disabled?(t.disabled=!1,this.container_sinais=!0,this.fibra.sinal_pto=0,e.target.classList.remove(`habilitado`),t.classList.remove(`is-disabled`),t.value=``):(t.disabled=!0,this.container_sinais=!1,this.fibra.sinal_pto=`LOS`,t.classList.add(`is-disabled`),e.target.classList.add(`habilitado`),t.value=0),this.objeto_os.salvar_os_localstorage()};_adicionar_sinal_fibra=e=>{let t=e.target.value;switch(e.target.id){case`text_sinal_drop`:this.fibra.sinal_pto=t;break;case`text_sinal_pathcord`:this.fibra.sinal_pathcord=t;break;case`text_sinal_autoisp`:this.fibra.sinal_autoisp=t;break}this.objeto_os.salvar_os_localstorage()};render(){return P`
            ...
            ${this.container_sinais===!0?P`
                ...
                `:``}
        `}};customElements.define(`verificacao-fibra`,ht);var gt=class extends G{static properties={nome:{type:String},tipo:{type:String},objeto_os:{type:Object},abaAtiva:{type:String}};static get styles(){return o`${a(We)}`}constructor(){super(),this.tipo=`continue`,this.abaAtiva=`aba1`,console.log(`Iniciando o Construtor`)}async connectedCallback(){if(super.connectedCallback(),this.tipo==`novo`){this.objeto_os=new Z(Ge),this.objeto_os.alterar_tipo_os(`completa`);try{let e=await Ye();this.objeto_os.carregar_latitude_longitude(e),X(`sucesso`,`OS atualizada com GPS`)}catch(e){X(`erro`,`Falha ao carregar coordenadas:\n${e}`),this.objeto_os.carregar_latitude_longitude(null)}}else this.objeto_os=new Z,this.objeto_os.carregar_os_localstorage()}firstUpdated(){this.atualizarUrlParaContinue()}atualizarUrlParaContinue(){if(window.location.pathname.endsWith(`/novo`)){let e=window.location.pathname.replace(`/novo`,`/continue`);window.history.replaceState(null,``,e)}}_alterarAba(e,t){e.preventDefault(),this.abaAtiva=t}render(){return P`
            <!--Retorno renderizado-->
...
<div class="form-container">
    ...
    <div class="form-group" style="margin-top: 10px;">
        ...
        `}};customElements.define(`page-os-completa`,gt);var _t=class extends G{static properties={notificacoes:{type:Array}};static get styles(){return o`
        ...
        `}constructor(){super(),this.notificacoes=[]}mostrarNotificacao(e,t){let n=Date.now(),r={id:n,categoria:e,mensagem:t};this.notificacoes=[...this.notificacoes,r],setTimeout(()=>{this.notificacoes=this.notificacoes.filter(e=>e.id!==n)},4e3)}connectedCallback(){super.connectedCallback(),window.addEventListener(`disparar-alerta`,e=>{let{categoria:t,mensagem:n}=e.detail;this.mostrarNotificacao(t,n)})}render(){return P`
            <div class="toast-container">
                ${this.notificacoes.map(e=>P`
        ...
        `}};customElements.define(`componente-notificacao`,_t);var $=window.location.hostname.includes(`github.io`)?`/Scripts-Lideran-a-Moto`:``,vt=class extends G{static properties={};constructor(){super(),this._router=new Se(this,[{path:`${$}/`,render:()=>P`<home-page url_config="${$}"></home-page>`},{path:`${$}/addos`,render:()=>P`<add-os></add-os>`},{path:`${$}/iniciar_os_completa`,render:()=>P`<page-os-completa></page-os-completa>`},{path:`${$}/iniciar_os_completa/:tipo`,render:e=>P`<page-os-completa .tipo="${e.tipo}"></page-os-completa>`},{path:`/perfil/:name`,render:e=>P`<h2>👤 Usuário: ${e.name}</h2>`},{path:`${$}/*`,render:()=>P`<erro-404></erro-404>`}])}static styles=[o`
    ...
    `}};customElements.define(`main-element`,vt);