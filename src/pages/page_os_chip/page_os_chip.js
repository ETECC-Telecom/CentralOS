...
import globalStyle from "./page_os_chip.css?inline";

import Controller_Objeto_OS_Chip from '../../controller/controller_objeto_os_chip';
import { Ordem_Servico_chip } from '../../model/objeto_os_chip';
...
//Execução do Serviço
import { Tratativa_Chip } from '../../components/componentes_formulario/tratativa_chip/tratativa_chip';
//Finalização
...
export class Page_OS_Chip extends LitElement {
    ...
    async connectedCallback() {
        ...
        if (this.tipo == 'novo') {
                    this.objeto_os = new Controller_Objeto_OS_Chip(Ordem_Servico_chip);
                    this.objeto_os.alterar_tipo_os("chip");
                    ...
                    this.objeto_os = new Controller_Objeto_OS_Chip();
    ...
    render() {
        return html`
            <!--Retorno renderizado-->
            <header-page-os
                titulo="Ordem de Serviço Entraga de Chip"
                retorno="/addos"
            ></header-page-os>
...
customElements.define('page-os-chip', Page_OS_Chip);