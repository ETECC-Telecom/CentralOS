...
import globalStyle from "./page_os_retencao.css?inline";
...
import { Ordem_Servico_Retencao } from '../../model/objeto_os_retencao';
...
//Execução do Serviço
import { Tratativa_Retencao } from '../../components/componentes_formulario/tratativa_retencao/tratativa_retencao';
...
export class Page_OS_Retencao extends LitElement {
    ...
    async connectedCallback() {
        ...
        if (this.tipo == 'novo') {
                    this.objeto_os = new Controller_Objeto_OS_Retencao(Ordem_Servico_Retencao);
                    this.objeto_os.alterar_tipo_os("retencao");
                    ...
                    this.objeto_os = new Controller_Objeto_OS_Retencao();
    ...
    render() {
        return html`
            <!--Retorno renderizado-->
            <header-page-os
                titulo="Ordem de Serviço de Retenção"
                retorno="/addos"
            ></header-page-os>
...
customElements.define('page-os-retencao', Page_OS_Retencao);