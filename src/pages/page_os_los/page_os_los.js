...
import globalStyle from "./page_os_los.css?inline";

import Controller_Objeto_OS_Los from '../../controller/controller_objeto_os_los';
import { Ordem_Servico_Los } from '../../model/objeto_os_los';
...
import { Tratativa_Los } from '../../components/componentes_formulario/tratativa_los/tratativa_los';
...
export class Page_OS_Los extends LitElement {
    ...
    async connectedCallback() {
        ...
        if (this.tipo == 'novo') {
            this.objeto_os = new Controller_Objeto_OS_Los(Ordem_Servico_Los);
            this.objeto_os.alterar_tipo_os("los");
            ...
            this.objeto_os = new Controller_Objeto_OS_Los();
...
customElements.define('page-os-los', Page_OS_Los);