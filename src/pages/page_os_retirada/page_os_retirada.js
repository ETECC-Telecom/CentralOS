...
import globalStyle from "./page_os_retirada.css?inline";

import Controller_Objeto_OS_Retirada from '../../controller/controller_objeto_os_retirada';
import { Ordem_Servico_Retirada } from '../../model/objeto_os_retirada';
...
// Sessão de Tratativa com o Cliente
...
//Execução do Serviço
import { Tratativa_Retirada } from '../../components/componentes_formulario/tratativa_retirada/tratativa_retirada';
import { Retirada_Insumos } from '../../components/componentes_formulario/retirada_insumos/retirada_insumos';
...
import { Componente_Acoes_Simples } from '../../components/componentes_formulario/componente_acoes_simples/componente_acoes_simples';

//Componentes de Formulário

export class Page_OS_Retirada extends LitElement {
    ...
    async connectedCallback() {
        ...
        if (this.tipo == 'novo') {
                    this.objeto_os = new Controller_Objeto_OS_Retirada(Ordem_Servico_Retirada);
                    this.objeto_os.alterar_tipo_os("retirada");
                    ...
                    this.objeto_os = new Controller_Objeto_OS_Retirada();
    ...
    render() {
        return html`
            <!--Retorno renderizado-->
            <header-page-os
                titulo="Ordem de Serviço de Retirada"
                retorno="/addos"
            ></header-page-os>
                ...
                ${this.abaAtiva === 'aba3' ? html`
                    <div class="container-item">
                        ...
                        <componente-info-extra
                            .objeto_os = "${this.objeto_os}"
                            .exibir_relatorio_bar = "${false}"
                        ></componente-info-extra>

                        <componente-acoes-simples
                            .objeto_os = "${this.objeto_os}"
                            .exibir_mensagem_whats = ${false}
                        ></componente-acoes-simples>
...
customElements.define('page-os-retirada', Page_OS_Retirada);