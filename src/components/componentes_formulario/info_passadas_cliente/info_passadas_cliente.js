...
export class Informacao_Passada_Cliente extends LitElement {
    ...
    connectedCallback() {
        ...
        this.info_passadas = this.objeto_os.OS.educacao_cliente;
    }
        ...
        return html`
            ...
            <div class="container_info_passadas">
                <div>
                    ...
                    ${educacao_cliente.map((item, chave) => html`
...
customElements.define('informacao-passada-cliente', Informacao_Passada_Cliente);