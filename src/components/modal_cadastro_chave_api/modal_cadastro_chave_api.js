...
import globalStyle from "./modal_cadastro_chave_api.css?inline";

import { CADASTRAR_CHAVE_API } from '../../controller/controler_API_IA';
export class Modal_Cadastro_Chave_API extends LitElement {
    static properties = {
        aberto: { type: Boolean } 
    };
        ...
        return html`
            <div id="container" class="${this.aberto ? 'visivel' : ''}">
                <div id="modal">
                    ...
                    <p><b>Chave da API</b></p>
                    <p>Para conseguir usar a função de Resumo por IA, cadastre uma chave do Gemini!</p>
...
customElements.define('modal-cadastro-chave', Modal_Cadastro_Chave_API);