...
export default class Controller_Objeto_OS_Retirada {
    ...
    */
    ...
    callback_adicionar_texto_inviabilidade(data) {
        const DATA = data;
        if (DATA !== "") {
            this.OS.motivo_cancelamento.inviabilidade_observacao = DATA;
        }
    }

    callback_adicionar_texto_troca_provedor(data) {
        const DATA = data;
        if (DATA !== "") {
            this.OS.motivo_cancelamento.troca_provedor_observacao = DATA;
        }
    }
    callback_adicionar_texto_outros_observacao(data) {
        const DATA = data;
        if (DATA !== "") {
            this.OS.motivo_cancelamento.outros_observacao = DATA;
        }
    }
    callback_adicionar_texto_insatisfacao_observacao(data) {
        const DATA = data;
        if (DATA !== "") {
            this.OS.motivo_cancelamento.insatisfacao_observacao = DATA;
        }
    }
    //===============================================================================================================
    ...
    Finalizar_OS_Simplificado = () => {
        let script = '==========================================================================\n';
        script += '                    ORDEM DE SERVIÇO - RETIRADA\n';
        script += '==========================================================================\n\n';
        ...
        script += this.relatorio_final_simples();

        script += this.conferencia_ativos_troca_simples();

        script += this.relatorio_complementar_simples();
    ...
    relatorio_final_simples = () => {
        let corpo = "";
        corpo += "MOTIVO DO CANCELAMENTO\n--------------------------------------------\n\n";
        
        const CATEGORIA = this.OS.motivo_cancelamento.categoria
        
        switch (CATEGORIA) {
            case "inviabilidade":
                corpo += `Inviabilidade...........: ${this.OS.motivo_cancelamento.inviabilidade_observacao}\n`
                
                break;
            case "condicao_financeira":
                corpo += `Condição Financeira.....:\n`
                
                break;
            case "mudanca_residencia":
                corpo += `Mudança de Residência...:\n`
                
                break;
            case "perda_equipamento":
                corpo += `Perda de Equipamento....:\n`
                
                break;
            case "troca_provedor":
                corpo += `Troca de Provedor.......: ${this.OS.motivo_cancelamento.troca_provedor_observacao}\n`
                
                break;
            case "obito_titular":
                corpo += `Óbito do Titular........:\n`
                
                break;
            case "insatisfacao":
                corpo += `Insatisfação Técnica....: ${this.OS.motivo_cancelamento.insatisfacao_observacao}`
                corpo += ` Relato do Cliente.: ${this.OS.info_cliente.relato_cliente === null?"Técnico não preencheu o relato do cliente!":this.OS.info_cliente.relato_cliente}\n`
                
                break;
            case "outros":
                corpo += `Outros Motivos..........: ${this.OS.motivo_cancelamento.outros_observacao}\n`
        ...
        corpo += `Comprovante retirada....: ${this.OS.conferencia_tecnica.comprovante_retirada === true? "Comprovante entregue ao Cliente":"Não foi entregue ao cliente"}\n`;
        corpo += `Fontes Retiradas........: ${this.OS.conferencia_tecnica.fontes_retiradas === true? "SIM":"NÃO"}\n`;
        corpo += `Fontes Fotos Anexadas...: ${this.OS.conferencia_tecnica.fotos_anexadas === true? "SIM":"NÃO"}\n`;
    ...
    Finalizar_OS_Markdown = () => {
        ...
        //Finalização
        script += this.relatorio_final_md();

        script += this.conferencia_ativos_troca_md();

        script += this.relatorio_complementar_md();
    ...
    relatorio_troca_ativo_script_md = () => {
        let corpo = "";
    ...
    conferencia_ativos_troca_md = () => {
        ...
        corpo += this.relatorio_troca_ativo_script_md();
